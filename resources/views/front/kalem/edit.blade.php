        ...
        <div class="col-md-12 widget-holder">
            <div class="widget-bg">
                <div class="widget-body clearfix">
                    <form enctype="multipart/form-data" action="{{route('kalem.update',['id'=>$data[0]['id']])}}" method="post">
                        @csrf
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                ...
                                <div>
                                    <input @if($data[0]['kalemTipi'] == 0) checked @endif class="change-customerType" checked type="radio" name="kalemTipi" value="0"> Gelir
                                </div>
                                <div>
                                    <input @if($data[0]['kalemTipi' ]== 1) checked @endif class="change-customerType"  type="radio" name="kalemTipi" value="1"> Gider
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row firma-area">
                            <div class="col-md-6">
                                <label class="col-form-label" for="l0">Kalem Adı</label>
                                    <input value="{{$data[0]['ad']}}" name="ad" class="form-control"  type="text">
                            </div>

                            <div class="col-md-6">
                                <label class="col-form-label" for="l0">Kdv</label>
                                    <input value="{{$data[0]['kdv']}}" name="kdv" class="form-control"  type="text">
                            </div>
                        </div>
                        ...
                        <div class="form-actions">
                            <div class="form-group row">
                                <div class="col-md-12 ml-md-auto btn-list">
                                    <button class="btn btn-primary btn-rounded" type="submit">Kalem Düzenle</button>
                                </div>
                            </div>
                        </div>
                    </form>
