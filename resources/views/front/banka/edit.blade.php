...
<div class="row page-title clearfix">
    <div class="page-title-left">
        <h6 class="page-title-heading mr-0 mr-r-5">Banka Düzenle</h6>
    </div>
    <!-- /.page-title-left -->
        ...
        <div class="col-md-12 widget-holder">
            <div class="widget-bg">
                <div class="widget-body clearfix">
                    <form enctype="multipart/form-data" action="{{route('banka.update',['id'=>$data[0]['id']])}}" method="post">
                        @csrf
                        ...
                        <div class="form-group row firma-area">
                            ...
                            <div class="col-md-4">
                                <label class="col-form-label" for="l0">Banka Iban</label>
                                    <input value="{{$data[0]['iban']}}"  name="iban" class="form-control"  type="text">
                            </div>

                            <div class="col-md-4">
                                <label class="col-form-label" for="l0">Banka HesapNo</label>
                                    <input  value="{{$data[0]['hesapNo']}}" name="hesapNo" class="form-control"  type="text">
                            </div>
                        </div>
                        ...
                        <div class="form-actions">
                            <div class="form-group row">
                                <div class="col-md-12 ml-md-auto btn-list">
                                    <button class="btn btn-primary btn-rounded" type="submit">Banka Düzenle</button>
                                </div>
                            </div>
                        </div>
                    </form>
