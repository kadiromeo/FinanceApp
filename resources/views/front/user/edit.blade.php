        ...
        <div class="col-md-12 widget-holder">
            <div class="widget-bg">
                <div class="widget-body clearfix">
                    <form enctype="multipart/form-data" action="{{route('user.update',['id'=>$data[0]['id']])}}" method="post">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <label class="col-form-label" for="l0">Kullanıcı Adı</label>
                                    <input name="name" class="form-control"  type="text" required value="{{$data[0]['name']}}">
                            </div>

                            <div class="col-md-12">
                                <label class="col-form-label" for="l0">Kullanıcı Şifre</label>
                                    <input name="password" class="form-control"  type="password" required value="{{$data[0]['password']}}">
                            </div>

                            <div class="col-md-12">
                                <label class="col-form-label" for="l0">Kullanıcı Email</label>
                                    <input name="email" class="form-control"  type="email" required value="{{$data[0]['email']}}">
                            </div>
                        ...
                        <div class="form-actions mt-2">
                            <div class="form-group row">
                                <div class="col-md-12 ml-md-auto btn-list">
                                    <button class="btn btn-primary btn-rounded" type="submit">Kullanıcı Düzenle</button>
                                </div>
                            </div>
                        </div>
                    </form>
