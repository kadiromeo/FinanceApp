                    ...
                    <form enctype="multipart/form-data" action="{{route('urun.store')}}" method="post">
                        ...
                        <div class="form-group row firma-area">
                            <div class="col-md-12">
                                <label class="col-form-label" for="l0">Ürün Adı</label>
                                    <input name="urunAdi" class="form-control"  type="text">
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input name="alisFiyati" class="form-control"  type="text">
                            </div>
                            <div class="col-md-6">
                                <label class="col-form-label" for="l0">Satış Fiyatı</label>
                                <input name="satisFiyati" class="form-control"  type="text">
                            </div>
                        </div>
                        ...
                        <div class="form-actions mt-2">
                            <div class="form-group row">
                                <div class="col-md-12 ml-md-auto btn-list">
                                    <button class="btn btn-primary btn-rounded" type="submit">Ürün Ekle</button>
                                </div>
                            </div>
                        </div>
                    </form>
