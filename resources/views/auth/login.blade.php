                ...
                <div class="w-50">
                    ...
                    <form class="text-center" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" placeholder="ornek@ornek.com" class="form-control form-control-line" name="email" >
                            @if ($errors->has('email'))
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" placeholder="******" class="form-control form-control-line" name="password" >
                        </div>
                        <!-- /.form-group -->
